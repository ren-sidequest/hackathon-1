...
const backendPort=process.env.EB_API3_TEST_BACKEND_PORT ?? '8793', candidatePort=process.env.EB_API3_TEST_CANDIDATE_PORT ?? '6373', hrPort=process.env.EB_API3_TEST_HR_PORT ?? '6386';
