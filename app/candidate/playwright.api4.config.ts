...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: `npm run dev -- --port ${candidatePort} --strictPort`, url: `http://127.0.0.1:${candidatePort}`, env: { VITE_APP_MODE: 'api4-connected', VITE_API_BASE_URL: `http://127.0.0.1:${backendPort}`, VITE_HR_WORKSPACE_URL: `http://127.0.0.1:${hrPort}/` }, reuseExistingServer: false },
    { command: `npm run dev --prefix ../hr -- --port ${hrPort} --strictPort`, url: `http://127.0.0.1:${hrPort}`, env: { VITE_APP_MODE: 'api4-connected', VITE_API_BASE_URL: `http://127.0.0.1:${backendPort}`, VITE_CANDIDATE_WORKSPACE_URL: `http://127.0.0.1:${candidatePort}/` }, reuseExistingServer: false },
  ],
});
