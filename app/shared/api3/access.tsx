...
import { Api3Error } from './client';

export const needsWriteAccess = (error: Api3Error | null) => !!error && (error.status === 401 || error.code === 'WRITE_AUTH_REQUIRED');
...
export function useWriteAccess(base: string, error: Api3Error | null) {
...
export function PermissionHelp({ base, error }: { base: string; error: Api3Error | null }) {
