import type { Demo, Finding, ProcessEvent, Submission, SubmitRequest } from '../api3-types';
...
export const draftKey = (data: Demo, version: number) => `evidencebridge.api3.draft.${data.sessionId}.${data.candidate.id}.${data.task.taskId}.v${version}`;
